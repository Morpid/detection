...
private:
    ...
    void setupMesh()
    {
		...
		glVertexAttribIPointer(5, 4, GL_INT, sizeof(VertexAnim), (void*)offsetof(VertexAnim, m_BoneIDs));

		// weights
		glEnableVertexAttribArray(6);
		glVertexAttribPointer(6, 4, GL_FLOAT, GL_FALSE, sizeof(VertexAnim), (void*)offsetof(VertexAnim, m_Weights));
        glBindVertexArray(0);
    }
};
#endif